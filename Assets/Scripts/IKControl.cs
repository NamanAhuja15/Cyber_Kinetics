...
public class IKControl : MonoBehaviour {
    ...
    private void Update()
    {
        gun = this.gameObject.GetComponent<GunInventory>().gun_new.GetComponent<GunScript>();
        leftElbowObj = gun.LeftElbow;
        rightElbowObj = gun.RightElbow;
        rightHandObj = gun.RightHand;
        leftHandObj = gun.LeftHand;
        gun.lookat = lookObj;
